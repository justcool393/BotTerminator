...
namespace BotTerminator.Modules
{
	...
	{
		public CommentScannerModule(BotTerminator bot) : base(bot, null, bot.RedditInstance.GetListing<Comment>(BotTerminator.NewModCommentsUrl, 300, BotTerminator.PageLimit))
		{
